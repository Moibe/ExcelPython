...
@author: Moibe
#Éste programa revisa los registros de excel para crear un json con los resultados del comercio de cada día.
"""
...
for row in js_param: 
    ...
    paypal_last_cell = row['paypal_last_cell'] #La última celda registrada del archivo de ventas de Paypal.
...
# =============================================================================
    ...
    valor_next = row['paypal_next'] 
    valor_tomahawk = row['paypal_tomahawk'] 
...
#Éste era el for usado cuando se escribía cada vez en el archivo un nuevo set de campañas, ahora se borran cada vez.
#for celda_adscampaigns_actual in range(celda_adscampaigns_actual, celda_adscampaigns_final + 1):
for i in range(2, 10):
        
    try: 
        print("ÉSTE ES EL i del FOR:")
        print(i)
        time.sleep(7)
        str_new_adscampaigns_actual = str(i)
        print("AQUÍ está convertido a string:")
        print(str_new_adscampaigns_actual)
        ...
        print("Celda Costo Campaña:")
        print(celda_costo_campana)
        campana = ws_adscampaigns[celda_campana].value
        costo_campana = ws_adscampaigns[celda_costo_campana].value
        print(campana)
        print("Costo que tuvo: ")
        print(costo_campana)
        #celda_adscampaigns_actual = celda_adscampaigns_actual + 1
        time.sleep(1)
        
        #Ésta es la parte importante, en donde se guarda lo que ha consumido la campaña.
        row[campana] = costo_campana
        
# =============================================================================
#         #Vamos a probar prescindir de todos éstos IFS.
#          #Ahora vas a sumar ese mismo valor a la campaña correspondiente:
#         if "GP - English World" in campana:
#             print("La campaña es GP - English Woooorld")
...
#             print(temp_europe)
#         elif "GP - English" in campana:
#             print("La campaña es GP - English a secas!!!!!!!!!!!!!!!!!!!")
#             print(costo_campana)
#             time.sleep(5)
#             temp_english = costo_campana
#             print("Valor temporal de English: ")
#             print(temp_english)
#         elif "MOI" in campana: 
#             print("ELIF MOI EN CAMPANA PASS")
# =============================================================================
...
new_paypal_last_cell = ws_moneystream.max_row


avance = new_paypal_last_cell - paypal_last_cell
print("Nuevas ventas: ")
print(avance)
        ...
        if producto: 
            ...
            if "EN" in producto:
                ...
                print(valor_en)
                    ...
                    print("El producto es EU!")
                    valor_eu = valor_eu + valor
                    print("Valor EU so far: ")
                    print(valor_eu)
            elif "US" in producto:
                    print("El producto es US!")
                    valor_us = valor_us + valor
                    print("Valor US so far: ")
                    print(valor_us)
            ...
            if "Alpha" in cuenta:
                ...
                print("Valor Alpha acumulado: ")
                print(valor_alpha)
            elif "fuelcom" in cuenta:
                print("La cuenta es Fuelcom: ")
                valor_fuel = valor_fuel + valor
                print("Valor Fuelbank acumulado: ")
                print(valor_fuel)
            elif "Gold" in cuenta:
                print("La cuenta es Moibe Gold: ")
                valor_gold = valor_gold + valor
                print("Valor MoibeGold acumulado: ")
                print(valor_gold)
            elif "NuevoOro" in cuenta:
                print("La cuenta es Nuevo Oro: ")
                valor_nuevoOro = valor_nuevoOro + valor
                print("Valor Nuevo Oro acumulado: ")
                print(valor_nuevoOro)
            elif "GSM" in cuenta:
                print("La cuenta es GSM : ")
                valor_gsm = valor_gsm + valor
                print("Valor GSM acumulado: ")
                print(valor_gsm)
            elif "JoyToei" in cuenta:
                print("La cuenta es JoyToei: ")
                valor_joy = valor_joy + valor
                print("Valor JoyToei acumulado: ")
                print(valor_joy)
            elif "linkedsys" in cuenta:
                print("La cuenta es LinkedSys: ")
                valor_linked = valor_linked + valor
                print("Valor LinkedSys acumulado: ")
                print(valor_linked)
            elif "telsat" in cuenta:
                print("La cuenta es Telsat: ")
                valor_telsat = valor_telsat + valor
                print("Valor Telsat acumulado: ")
                print(valor_telsat)
            elif "MMC" in cuenta:
                print("La cuenta es MMC: ")
                valor_telsat = valor_telsat + valor
                print("Valor MMC acumulado: ")
                print(valor_mmc)
            elif "SKK" in cuenta:
                print("La cuenta es Skk: ")
                valor_telsat = valor_telsat + valor
                print("Valor Skk acumulado: ")
                print(valor_skk)
            elif "Dreamnet" in cuenta:
                print("La cuenta es Dreamnet: ")
                valor_dreamnet = valor_dreamnet + valor
                print("Valor Dreamnet acumulado: ")
                print(valor_dreamnet)
            elif "Next" in cuenta:
                print("La cuenta es Next: ")
                valor_next = valor_dreamnet + valor
                print("Valor Next acumulado: ")
                print(valor_next)
            elif "Tatanka" in cuenta:
                print("La cuenta es Tatanka: ")
                valor_tomahawk = valor_tomahawk + valor
                print("Valor Tatanka acumulado: ")
                print(valor_tomahawk)
           
            suma = suma + valor
            print("Valor total acumulado: ")
            print(suma)
            celda_actual = celda_actual + 1
        else: 
            print("NO EXISTE UN PRODUCTO...")
            time.sleep(4)
    except: 
            print("Se saltó la asignación hacia el producto y hacia la cuenta porque no hay producto, fue un 0....")
...
#Esto será el total de todo lo que tenemos en el día. 
print("El valor en éste momento de suma es:")
print(suma)
time.sleep(3)

all_win = suma - ads_spent
print("Hemos ganado:")
print(all_win)
time.sleep(5)
...
# =============================================================================
    ...
    row['paypal_nuevoOro'] = valor_nuevoOro
